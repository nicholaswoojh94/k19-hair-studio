...
export default function HomeClient({ initialSiteImages }: { initialSiteImages: Record<string, string | null> }) {
  const { t } = useLang()
  useFadeUp()

  const [galleryPhotos, setGalleryPhotos] = useState<any[]>([])
  const [footerHours, setFooterHours] = useState<any[]>([])
  const [siteImages, setSiteImages] = useState<Record<string, string | null>>(initialSiteImages)
